...
![](images/Captura de pantalla (347).png)

## Comando 2:

![](images/Captura de pantalla (348).png)

## Comando 3:

![](images/Captura de pantalla (349).png)

# Parte de Planificación

## Ordenamiento de la Literatura

![](imagenes/literatura.png){fig-align="center" width="633"
height="150"}
...
![Histograma frecuencial de los juegos lanzados por
año.](FreqGamesPerYear.png){fig-align="center" width="137mm"}

![Dispersión entre la variable nota en Metacritic con la de jugadores
estimados.](imagenes/GamersAndCriticsRelations.png){fig-align="center"
width="138mm"}

![Dispersión hexagonal de las variables jugadores estimados y
precio.](imagenes/Rplot02.png){fig-align="center" width="138mm"
height="92mm"}

![Distribución y Comparativa del Tiempo de Juego Promedio por
plataforma](imagenes/GrafJoseph1.png){fig-align="center" width="138mm"
height="92mm"}

![Distribución de Jugadores Estimados a lo Largo del
...
![](imagenes/GrafRespaldoJ.png){fig-align="center" width="138mm"
height="92mm"}
