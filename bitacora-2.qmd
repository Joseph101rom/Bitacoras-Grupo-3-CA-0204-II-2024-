...
![Gráfico 1: Histograma sobre la variable de fechas de
lanzamiento.](imagenes/HistogramaFechasLanzamiento.png){fig-alt="."
fig-align="center" width="137mm" height="108mm"}

![Gráfico 2: Distribución Jugadores estimados y notas en
Metacritic.](imagenes/GamersAndCriticsRelations.png){fig-align="center"
width="138mm" height="93mm"}
...
height="92mm"} ![Gráfico 4: Distribución y Comparativa del Tiempo de
Juego Promedio por
plataforma](imagenes/GrafJoseph1.png){fig-align="center" width="138mm"
height="92mm"} ![Gráfico 5:Distribución de Jugadores Estimados a lo
Largo del Tiempo](imagenes/GrafJoseph2.png){fig-align="center"
width="138mm" height="92mm"} \## Propuesta Metodológica
...
\[
\text{Minimizar} \quad \sum_{i=1}^{n} \sum_{j=1}^{k} \|x_i - c_j\|^2
\]
